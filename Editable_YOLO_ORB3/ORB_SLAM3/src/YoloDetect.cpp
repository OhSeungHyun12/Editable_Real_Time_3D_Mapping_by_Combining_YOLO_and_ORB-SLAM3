    ...
    : device(torch::kCPU)
{
    ...
    // 1) Save file path
    std::string model_path = "/home/ruherpan/Editable_YOLO_ORB3/ORB_SLAM3/yolo11n.torchscript.pt";
    std::string names_path = "/home/ruherpan/Editable_YOLO_ORB3/ORB_SLAM3/coco.names";
